...
var Scorekeeper_1 = __webpack_require__(5);
...
var Game = /** @class */ (function () {
    ...
    Game.prototype.addEvent = function (event, target, value) {
        var update = {
            event: event,
            ts: new Date(),
            target: target,
    ...
    Game.prototype.removePlayer = function (name) {
        var player = { name: name };
        this.players = this.players.filter(function (p) { return p.name != name; });
        this.addEvent("remove_player", player, undefined);
    };
    Game.prototype.changeScore = function (name, score) {
        this.addEvent("change_score", { name: name }, { currentScore: score });
    };
    Game.prototype.currentScores = function () {
        var scores = {};
        var scoreChanges = this.history.filter(function (e) { return e.event == "change_score"; });
        for (var _i = 0, scoreChanges_1 = scoreChanges; _i < scoreChanges_1.length; _i++) {
            var e = scoreChanges_1[_i];
            scores[e.target.name] = e.value;
        }
        var current = [];
        var idx = 0;
        for (var _a = 0, _b = this.players; _a < _b.length; _a++) {
            var p = _b[_a];
            var score = scores[p.name] ? scores[p.name] : 0;
...
var NewPlayer_1 = __webpack_require__(10);
var Scorekeeper = /** @class */ (function (_super) {
    __extends(Scorekeeper, _super);
    function Scorekeeper(props) {
        var _this = _super.call(this, props) || this;
        _this.state = { game: _this.props.game };
        _this.changeScore = _this.changeScore.bind(_this);
        _this.addPlayer = _this.addPlayer.bind(_this);
        _this.removePlayer = _this.removePlayer.bind(_this);
        return _this;
    }
    Scorekeeper.prototype.generateColor = function (name) {
        var hash = MD5(name + "."); // magic nonce makes our names look better :)
        var color = Color("#" + hash.slice(hash.length - 6));
        return color.darken(0.4).toString();
    };
    Scorekeeper.prototype.changeScore = function (name, score) {
        var game = this.state.game;
        game.changeScore(name, score);
        this.setState({ game: game });
    };
    Scorekeeper.prototype.addPlayer = function (name) {
        var game = this.state.game;
        game.addPlayer(name);
        this.setState({ game: game });
    };
    Scorekeeper.prototype.removePlayer = function (name) {
        var game = this.state.game;
...
var Counter = /** @class */ (function (_super) {
    ...
    function Counter(props) {
        var _this = _super.call(this, props) || this;
        _this.state = { score: props.score };
        _this.changeScore = _this.changeScore.bind(_this);
        _this.handleRemove = _this.handleRemove.bind(_this);
        return _this;
    }
    Counter.prototype.changeScore = function (delta) {
        var newScore = this.state.score + delta;
        this.setState({ score: newScore });
        this.props.scoreHandler(this.props.player, delta);
    };
    Counter.prototype.handleRemove = function () {
    ...
    Counter.prototype.render = function () {
        ...
        return React.createElement("div", { className: "sk-counter", style: style },
            React.createElement("span", { className: "sk-counter-name" }, this.props.player),
            React.createElement("button", { className: "sk-counter-decr", onClick: function (_) { return _this.changeScore(-1); } }, " - "),
            React.createElement("span", { className: "sk-counter-score" }, this.state.score),
            React.createElement("button", { className: "sk-counter-incr", onClick: function (_) { return _this.changeScore(1); } }, " + "),
            React.createElement("button", { className: "sk-player-remove", onClick: this.handleRemove }, " X "));
    };
    return Counter;
}(React.Component));
...
var NewPlayer = /** @class */ (function (_super) {
    ...
    NewPlayer.prototype.handleSubmit = function (event) {
    ...
    NewPlayer.prototype.handleInput = function (event) {
        var target = event.target;
        this.setState({ name: target.value });
    };
    NewPlayer.prototype.render = function () {
        return React.createElement("form", { className: "sk-newplayer-form" },
            React.createElement("input", { type: "text", onChange: this.handleInput, placeholder: "New player name", value: this.state.name }),
            React.createElement("button", { className: "sk-newplayer-button", onClick: this.handleSubmit }, "Ok"));
    };
    return NewPlayer;
}(React.Component));
